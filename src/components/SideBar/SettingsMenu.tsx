...
const SettingsMenu: React.FC = () => {
    ...
    const [checkedWorkspaces, setCheckedWorkspaces] = React.useState<Record<string, boolean>>({});
  ...
  const renderOptionContent = (option: string) => {
    switch (option) {
      ...
      case 'Delete Account':
        ...
        case 'Rustic Woods':
        case 'Golden Sahara':
          return <ThemeSettings selectedTheme={option}/>;
        default:
          return null;          
    }
  };
                  ...
                  <div className="flex flex-row h-[15%] justify-between">
                    ...
                    <div className='flex gap-6'>
                      <button
                        ...
                        className=" max-h-[43px] bg-bu text-white px-4 py-2 rounded hover:bg-bu-1"
                      >
                        Add Workspace
                      </button>
                      <button
